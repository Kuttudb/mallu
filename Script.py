class script(object):
    START_TXT = """<b>ʜᴇʟʟᴏ {}, Nɪᴄᴇ Tᴏ Mᴇᴇᴛ Yᴏᴜ 🙌 
Iᴛ's A Mᴏᴠɪᴇ Sᴇᴀʀᴄʜ Bᴏᴛ Mᴀᴅᴇ Bʏ Mᴀʟʟᴜғɪʟᴇs.
I Cᴀɴ Pʀᴏᴠɪᴅᴇ Mᴏᴠɪᴇs,Sᴇʀɪᴇs Oɴ Yᴏᴜʀ Gʀᴏᴜᴘ, 
Jᴜsᴛ Aᴅᴅ Mᴇ Tᴏ Yᴏᴜʀ Gʀᴏᴜᴘ Aɴᴅ Eɴᴊᴏʏ 😍</b>"""

    HELP_TXT = """<b>Hᴇʏ {}
Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""

    ABOUT_TXT = """<b>✯ Bᴏᴛ Nᴀᴍᴇ: {}
➩ Cʀᴇᴀᴛᴏʀ: <a href='https://t.me/mallufiles'>@Mᴀʟʟʟᴜғɪᴇs</a>
➩ Lɪʙʀᴀʀʏ: <a href='https://docs.pyrogram.org/'>Pʏʀᴏɢʀᴀᴍ</a>
➩ Lᴀɴɢᴜᴀɢᴇ: <a href='https://www.python.org/download/releases/3.0/'>Pʏᴛʜᴏɴ 3</a>
➩ Bᴏᴛ Sᴛᴀᴛᴜs: Oɴʟɪɴᴇ 🟢[ Sᴛᴀʙʟᴇ ]</b>"""
...
🚯 ᴅᴏɴᴛ ᴜꜱᴇ ➠ ':(!,./)</b>"""
    ...
    NORSLTSBT = """ <b>sᴏʀʀʏ ɴᴏ ꜰɪʟᴇs ᴡᴇʀᴇ ꜰᴏᴜɴᴅ ꜰᴏʀ ʏᴏᴜʀ ʀᴇǫᴜᴇꜱᴛ {} 😕

‼️🔍ᴄʜᴇᴄᴋ ʏᴏᴜʀ sᴘᴇʟʟɪɴɢ ɪɴ ɢᴏᴏɢʟᴇ ᴀɴᴅ ᴛʀʏ ᴀɢᴀɪɴ 🔄

⚠️ Iғ Rᴇǫᴜᴇsᴛᴇᴅ Mᴏᴠɪᴇ Is Nᴏᴛ Aᴠᴀɪʟᴀʙʟᴇ Pʟᴇᴀsᴇ Sᴇɴᴅ ᴀ Rᴇǫᴜᴇsᴛ Tᴏ Oᴜʀ Rᴇǫᴜᴇsᴛ Gʀᴏᴜᴘ Wɪᴛʜ Tʜᴇ Cᴏᴍᴍᴀɴᴅ ✏️ #𝚛𝚎𝚚𝚞𝚎𝚜𝚝 Mᴏᴠɪᴇ Nᴀᴍᴇ ᴀɴᴅ ʏᴇᴀʀ.</b> """
...
• ᴜꜱᴇʀɴᴀᴍᴇ : @mallufiles
• ᴘᴇʀᴍᴀɴᴇɴᴛ ᴅᴍ ʟɪɴᴋ : <a href='t.me/mallufiles'>Cʟɪᴄᴋ Hᴇʀᴇ</a></b>"""
